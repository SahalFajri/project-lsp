    ...
    <div class="card shadow">
      <div class="card-body">
        <form class="d-flex mb-3" role="search">
          <input name="search" class="form-control me-2 shadow-sm" type="search" placeholder="Cari berdasarkan id" aria-label="Search" value="{{ request('search') }}">
        ...
        <table class="table table-bordered border-dark table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><a href="/dashboard/aspirasis/{{ $aspirasi->id }}" class="btn btn-info btn-sm"><i class="bi bi-eye"></i></a></td>
            </tr>
            @endforeach
            @else
            <tr>
