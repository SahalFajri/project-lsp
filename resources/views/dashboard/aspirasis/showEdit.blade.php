      ...
      <div class="card shadow">
        ...
        <ul class="list-group list-group-flush">
          ...
          <li class="list-group-item">
            ...
            <select name="status" class="form-select shadow-sm d-inline w-auto" aria-label="Default select example" id="kategori">
              <option {{ ($aspirasi->status == 'Menunggu') ? 'selected' : '' }} value="Menunggu">Menunggu</option>
              <option {{ ($aspirasi->status == 'Proses') ? 'selected' : '' }} value="Proses">Proses</option>
              <option {{ ($aspirasi->status == 'Selesai') ? 'selected' : '' }} value="Selesai">Selesai</option>
            </select>
          </li>
        </ul>    
        <div class="card-body">
          ...
          <p>
            <textarea name="feedback" class="form-control @error('feedback') is-invalid @enderror shadow-sm" placeholder="Tulis feedback di sini" id="feedback">{{ $aspirasi->feedback }}</textarea>
            @error('feedback')
